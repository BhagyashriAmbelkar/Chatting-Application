...
public class Server implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        dout.writeUTF(out); //to read te output
    ...
    public static void main(String[]args){
        ...
        try{
            ...
            while(true){
                Socket s = skt.accept(); //to accept messages
                DataInputStream din =new DataInputStream(s.getInputStream());  //to read input
                dout = new DataOutputStream(s.getOutputStream()); //to read output
                
                while(true){
                    String msg = din.readUTF(); //store the read message in msg
                    JPanel panel = formatLabel(msg); //display the msg on the panel
                    
                    JPanel left = new JPanel(new BorderLayout()); //display received messages on the left side 
